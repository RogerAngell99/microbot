...
public class MainPanel extends PluginPanel {
    ...
    public void refresh() {
        try {
            if (debugWriter != null) {
                debugWriter.write("MainPanel: refresh() called\n");
                debugWriter.write("MainPanel: isLoggedIn() = " + loginResponseManager.isLoggedIn() + "\n");
            }
        } catch (IOException e) {
            // ignore
        }
    ...
    public void renderLoggedOutView() {
        try {
            if (debugWriter != null) {
                debugWriter.write("MainPanel: renderLoggedOutView() called\n");
            }
        } catch (IOException e) {
            // ignore
        }
    ...
    public void renderLoggedInView() {
        try {
            if (debugWriter != null) {
                debugWriter.write("MainPanel: renderLoggedInView() called\n");
            }
        } catch (IOException e) {
            // ignore
        }
    ...
    public void onActivate() {
        ...
        try {
            if (debugWriter != null) {
                debugWriter.write("MainPanel: onActivate() called\n");
            }
        } catch (IOException e) {
            // ignore
        }
