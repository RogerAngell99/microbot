...
public class UIUtilities {
    public static final String discordIcon = "/net/runelite/client/plugins/microbot/flippingCopilot/discord.png";
    public static final String githubIcon = "/net/runelite/client/plugins/microbot/flippingCopilot/github.png";
    public static final String logoutIcon = "/net/runelite/client/plugins/microbot/flippingCopilot/logout.png";
    public static final String internetIcon = "/net/runelite/client/plugins/microbot/flippingCopilot/internet.png";
    public static final String graphIcon = "/net/runelite/client/plugins/microbot/flippingCopilot/graph.png";
