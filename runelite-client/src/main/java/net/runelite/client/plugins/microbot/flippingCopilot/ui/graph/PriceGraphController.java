...
public class PriceGraphController {
    ...
    private final JLabel itemIcon = new JLabel(new ImageIcon(ImageUtil.loadImageResource(getClass(),"/net/runelite/client/plugins/microbot/flippingCopilot/small_open_arrow.png")));
    ...
    private void showGraphView(String itemName, Data data) {
        ...
        try {
            BufferedImage gearIcon = ImageUtil.loadImageResource(PriceGraphController.class, "/net/runelite/client/plugins/microbot/flippingCopilot/preferences-icon.png");
