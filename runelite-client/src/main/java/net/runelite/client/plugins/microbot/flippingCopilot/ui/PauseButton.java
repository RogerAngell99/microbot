...
public class PauseButton extends JButton {
    ...
    static {
        var play = ImageUtil.loadImageResource(PauseButton.class, "/net/runelite/client/plugins/microbot/flippingCopilot/play.png");
        var pause = ImageUtil.loadImageResource(PauseButton.class, "/net/runelite/client/plugins/microbot/flippingCopilot/pause.png");
